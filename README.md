...
### 1. Expense & Investment Tracker (`My_python_practice.ipynb`)
* **Objective:** Tracks income, dynamic expense categories, and capital allocations.
* **Key Features:**
  * Interactive transaction logging via Python functions.
  * Category-based expenditure aggregation using dictionaries.
